...
// 引用链接: https://raw.githubusercontent.com/TamperAcc/Clash/main/Clash/Mihomo_Override.js
// 加速链接: https://cdn.jsdelivr.net/gh/TamperAcc/Clash@main/Clash/Mihomo_Override.js
// 版本: v1.17 (自动更新版) | 更新日期: 2026-01-26
// 移植自 ClashVerge.yaml "PC 端终极优化版"

function main(config) {
  // 打印日志方便调试 (在软件日志中可见)
  console.log("🔵 [Script] 正在应用 Mihomo Party 覆写脚本 v1.17...");
